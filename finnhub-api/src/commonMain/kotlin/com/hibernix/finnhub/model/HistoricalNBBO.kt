 ...
 * @property ax List of venues/exchanges - Ask price. A list of exchange codes can be found [here](https://docs.google.com/spreadsheets/d/1Tj53M1svmr-hfEtbk6_NpVR1yAyGLMaH6ByYU6CG0ZY/edit?usp=sharing)
 * @property bv List of Bid volume data.
 * @property b List of Bid price data.
 * @property bx List of venues/exchanges - Bid price. A list of exchange codes can be found [here](https://docs.google.com/spreadsheets/d/1Tj53M1svmr-hfEtbk6_NpVR1yAyGLMaH6ByYU6CG0ZY/edit?usp=sharing)
 * @property t List of timestamp in UNIX ms.
 * @property c List of quote conditions. A comprehensive list of quote conditions code can be found [here](https://docs.google.com/spreadsheets/d/1iiA6e7Osdtai0oPMOUzgAIKXCsay89dFDmsegz6OpEg/edit?usp=sharing)
 */
@Serializable
